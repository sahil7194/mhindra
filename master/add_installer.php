...
<body>
	...
	<div class="working-section">
		<div class="data-section">
			<span>
				<h1 style="text-align:center; font-size: 40px;">Add Installer</h1>
				<div class="from-data">
						...
						<form action="" method="post">
							<table>
								<tr>
									...
									<td>
										<input type="text" name="vendor_name" placeholder="Installer Name">
									</td>
								</tr>
									<tr>
									<td>
					...
					if (isset($_POST['submit']))
					{
						...
						if ($vendor_name!="")
						{
							$sql_for_insert="INSERT INTO `installer`(`Name`, `Mobile`, `Address`) VALUES ('$vendor_name','$vendor_number','$address')";
							$run_insert=mysqli_query($conn,$sql_for_insert);
							if ($run_insert== true)
							{
								echo "<script>alert('Installer Added successfully')</script>";	
							}
						}
						else
						{
							echo "<script>alert('Installer Name Required')</script>";
						}
					}
					 ?>
				</div>
