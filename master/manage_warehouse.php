...
<main class="main-menue">
	...
	<div class="working-section">
		<div class="data-section">
			<span>
				<h1 style="text-align:center; font-size: 40px;">Manage WareHouse</h1>
				<div class="export" style="margin-left: 80px; margin-top: 20px;">
					Export
					<a href="download_warehouse.php">Excel</a>
				</div>
					...
					error_reporting('0'); 
						...
						while ($row_warehouse=mysqli_fetch_array($run_select))
						{
							...
							<tr><td><?php echo $counter; ?></td>
								...
								<td><?php echo $row_warehouse['incharge']; ?></td>
								<td><?php echo $row_warehouse['location']; ?></td>
