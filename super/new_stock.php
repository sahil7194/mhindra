	...
	<div class="working-section">
		<div class="data-section">
			...
			<div class="table-class">
				<div style="height:485px; width: 1200px; overflow: auto; padding-left: 20px; padding-top: 10px; padding-bottom: 15px;">
				<table border="1">
					<tr>
						<td rowspan="2">
							Sr. No.
					...
					<?php 
							...
							$select_table_data_query="SELECT `id`, `ItemCode`, `ItemName`, `UOM`, `Note`, `Qauntity`, `DamageQuantity`, `warehouse`, `Sacnable`, `FixedQuantity`, `FixedValue`, `ItemValue` FROM `item` WHERE `warehouse`='$warehouse'";
					...
					<tr>
						...
						<td>
							<?php echo in($row_table_data['ItemName'],$warehouse); ?>
						</td>
						<td>
							<?php echo $row_table_data['DamageQuantity'] ?>
						</td>
						<td>
							<?php echo out($row_table_data['ItemName'],$warehouse); ?>
						</td>
						<td>
