			...
			<span style="margin-left: 90px;">
				...
				<table style="margin-left: 30px; width: 1160px; margin-top: 20px;" border="1">
					...
					<?php 
						...
						$get_data = "SELECT `id`, `invoiceNumber`, `ItemName`, `Quantity`, `Value`, `serialNumber`, `WorkDoneBy`, `CreateDate` FROM `outward`  WHERE `warehouse`='$warehouse' ORDER BY `CreateDate` DESC";
						...
						while ($row_data=mysqli_fetch_assoc($run_data))
						{
							...
							?>
								<tr>
									...
									<td><a target="_blank" href="detials_outward.php?id=<?php echo $row_data['invoiceNumber'];?>">Deatils</a></td>
								</tr>
							<?php
						}
					 ?>
