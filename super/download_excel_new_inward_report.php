<?php
 ...
 $table_data="<table style='margin-left: 30px; width: 1160px; margin-top: 20px;''>
					<tr style='font-size: 25px; ''>
						...
						$get_data = "SELECT `id`, `invoiceNumber`, `ItemName`, `Quantity`, `Value`, `serialNumber`, `WorkDoneBy`, `CreateDate` FROM `inward` ORDER BY `CreateDate` DESC";
	...
	header('Content-Disposition:attachment;filename=new_inward_report.xls');
 	echo $table_data;