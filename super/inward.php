<?php
	...
	{
		header('Location:http://localhost/Current%20Project/mahindra/super/manage_deliviray_order.php');
	}
  ?>
<!DOCTYPE html>
<html>
					...
					<table class="table1">
				   	<tr>
							...
							<td>
								...
								<input id="name" type="text" list="invoicelist" name="delivery_note_number" placeholder="Invoice Number" value="<?php echo $in_1;?>" onkeyup="uppercase()">
							</td>
						</tr>
						<tr>
							<td>
						...
						<tr>
							...
							<td>
								<input type="text" name="text" id="text"  placeholder="Serial Number">
							</td>
						</tr>
