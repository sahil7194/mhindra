		...
		<div class="data-section">
			...
			<div class="workspace">
				...
				<table style="margin-top: 10px;" border="1">
					...
					<?php 
						$sql_for_select_pro="SELECT `id`, `procurement_id`, `State`, `dist`, `WareHouse_location`, `Govt_Customer_Name`, `Address`, `Motor HP`, `Pump_Type`, `Motor_Type`, `Module`, `Order_Quantity`, `CreateDate`, `VendorStatus` FROM `procurement` ORDER BY `CreateDate` DESC";
						...
						<td>
							...
							<?php if ($v=='NotAdd')
								{
									?>
										<a style="color: red;" target="_blank" href="add_vendor.php?id=<?php echo $row_pro['procurement_id']; ?>&hp=<?php echo $row_pro['Motor HP']; ?>">Add Vendor</a>
									<?php
								}
								else
								{
						...
						<td>
							<a target="_blank" href="view_bom_for_vendor.php?id=<?php echo $row_pro['procurement_id']; ?>&hp=<?php echo $row_pro['Motor HP']; ?>">View BOM</a>
						</td>
					</tr>
							<?php
						}
