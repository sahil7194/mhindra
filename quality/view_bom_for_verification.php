	...
	<tr>
		<td colspan="3">
			<table border="1" style="width:100%;">
				...
				<?php
				error_reporting('0'); 
					$select_data="SELECT `id`, `ProcumentID`, `ItemCode`, `ItemName`, `UOM`, `Qunatity`, `CreatedDate`, `VendorAddDate`, `VendorName`, `Price`,`Review` FROM `bom` WHERE `ProcumentID`='$Invoice_number'";
